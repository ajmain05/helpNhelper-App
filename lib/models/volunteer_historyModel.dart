class VolunteerHistoryModel {
  ...
  set application(Application? application) => _application = application;
  User? get user => _user;
  set user(User? user) => _user = user;

  VolunteerHistoryModel.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _seekerApplicationId = json['seeker_application_id'];
    _userId = json['user_id'];
    _createdAt = json['created_at'];
    _updatedAt = json['updated_at'];
    _application = json['application'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._application != null) {
      data['application'] = this._application!.toJson();
    }
    if (this._user != null) {
